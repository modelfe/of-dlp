...
**Instructions**:
1. Download the script and place it in a folder (e.g. /home/user/of-dlp or C:\Users\YourUsername\of-dlp).
...
5. On first run, a Python virtual environment (.venv) is created automatically, and playwright/pywidevine are installed. A Chromium browser opens to OnlyFans – log in once. Subsequent runs stay logged in.
